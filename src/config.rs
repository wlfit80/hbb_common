...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "yes@2025".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["jjx.freenas.site"];
pub const RS_PUB_KEY: &str = "4n1ErBWfZbwVRgSY1t86+VU8J0VeUNrUsvFdXkpXwY8=";
